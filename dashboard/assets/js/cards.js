...
(function (root, factory) {
  ...
  /* Сколько карточек ставить в строку, чтобы строки вышли равными.
     ...
     Скажем, в строку влезает десять карточек, а их — двенадцать: простое
     заполнение по десять оставило бы вторую строку из двух карточек и
     пустоту за ней, и ряд читался бы как недоделанный. Считаем, сколько
     строк выходит при самой плотной раскладке, и делим карточки на эти
     строки поровну — двенадцать по шесть это шесть и шесть, обе строки
     полные.

     Считалка чистая и не завязана на то, кто её вызвал: одну и ту же
     раскладку по ней считают и ряд срезов «Изменений», и ряды «Состояния».
     Ширину и отступ меряет тот, у кого есть раскладка. */

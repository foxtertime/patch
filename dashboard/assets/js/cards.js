...
(function (root, factory) {
  ...
  function stateCards(snap) {
    ...
    /* Три группы: сколько всего, что у билдов внутри и как прошёл сбор.
       В первой одно число — та точка отсчёта, к которой приводят остальные
       четыре, и стоять оно должно крупнее их. */
    const big =
      group('lead',

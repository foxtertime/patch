...
(function (root, factory) {
  ...
  function create(deps) {
    ...
    box.addEventListener('wheel', (e) => {
      ...
      /* На краю цепочки колесо отдаётся странице: иначе рельс ловил бы
         прокрутку и держал страницу на месте — курсор проходит над ним по
         пути вниз, и остановка под ним читалась бы как зависшая страница. */
      if ((step < 0 && at <= 0) || (step > 0 && at >= room)) return;
      e.preventDefault();
      box.scrollLeft = at + step;
    }, { passive: false });

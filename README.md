...
Того, что видно в самой строке, раскрытие не повторяет: владельца, метки и
время сборки там нет — они стоят строчкой выше, в своих колонках. В
раскрытии остаётся то, чему в строке места нет: NVR, список koji-тегов,
идентификаторы билда и задачи, проект и ветка GitLab, списки патчей и
пакетов. Исключение одно — время сборки: в раскрытии оно стоит целиком, с
пометкой `МСК`, потому что в колонке секунды набраны бледнее и читаются
хуже.

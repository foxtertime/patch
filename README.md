...
линия под ней читалась бы как часть рисунка. На конце цепочки колесо
достаётся странице, так что рельс не держит её, когда курсор проходит над
ним по пути вниз. Отрезок при этом не ужимается уже своей подписи: длинная
цепочка уезжает за край, но «31 дн» над отрезком не наползает на соседние
узлы.

...
Снапшот выбирают на том же рельсе, что стоит над вкладками: клик по узлу
открывает его, открытый узел залит. Отдельного переключателя нет — число
сборок и полное время сбора каждого снапшота стоят в списке источников,
рядом с именем файла. При единственном снапшоте узел не нажимается:
переключать не на что. Открывается вкладка на последнем снапшоте цепочки —

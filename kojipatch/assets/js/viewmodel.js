...
(function (root, factory) {
  ...
  /* Отсутствующий ключ и null — одно и то же «неизвестно», но в JSON они
     выглядят по-разному: undefined из объекта пропадает целиком, а
     сравнение с эталоном (page-data.golden.json) идёт через JSON —
     пропавший ключ и null там неразличимы. Поэтому неизвестное всегда
     приводится к null явно. */
